...
//        cp.insertClassPath("D:\\project\\demo\\java8\\src\\main\\java\\com\\java8\\javassist\\clazz");
...
//
//        CtClass point = pool.get("com.java8.javassist.clazz.Rectangle");
//        CtConstructor m = CtNewConstructor.make(
//                "Point() {}", point);
//        point.addConstructor(m);
//        CtClass ct = pool.get("com.java8.javassist.clazz.Rectangle");
////        CtConstructor m1 = CtNewConstructor.make(
////                "public Rectangle() {}", ct);
////        ct.addConstructor(m1);
//        ct.setSuperclass(pool.get("com.java8.javassist.clazz.Point"));
//        Class c = c1.loadClass("com.java8.javassist.clazz.Rectangle");
//        Object rect = c.newInstance();
//

        Translator t = new MyTranslator();
        ClassPool pool = ClassPool.getDefault();
        pool.insertClassPath("D:\\project\\demo\\java8\\src\\main\\java\\com\\java8\\javassist\\clazz");
